...
app = Flask(__name__)
app.config["MONGO_URI"] = "mongodb://172.18.0.35:27017/DBgabriel"
...
#    Client(name='Claudinho', email='cla@univille.br', phone="1231234"),
#    Client(name='Luizinho', email='lu@univille.br', phone="55412434"),
#    Client(name='Dioneizinho', email='di@univille.br', phone="5231234")
#]
